            ...
            @endforeach
                    ...
                    <div class="qr-creator-layout-3-col">
                        ...
                        <div class="qr-creator-panel preview-panel">
                            ...
                            <button type="submit" class="submit-btn create-qr-btn w-100">
...
$(document).ready(function() {
    ...
    // Initial setup
    const initialCategory = $('.content-tab.active');
    if (initialCategory.length) {
        selectContentType(initialCategory.data('category'), initialCategory.data('name').toLowerCase().replace(' ', '-'));
    }
    updatePreview();
