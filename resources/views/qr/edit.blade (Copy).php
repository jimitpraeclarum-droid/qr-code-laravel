                    ...
                    <div class="design-section">
                        ...
                        <div class="color-options">
                            ...
                            <div class="color-group">
                                ...
                                <div class="color-picker-group">
                                    <input type="color" id="bg-color" name="bg_color" value="{{ old('bg_color', $qrCode->bg_color ?? '#ffffff') }}">
                                    <input type="text" id="bg-color-hex" value="{{ old('bg_color', $qrCode->bg_color ?? '#ffffff') }}">
                                </div>
                            </div>
                            <div class="color-group">
                                <label>Squares:</label>
                                <div class="color-picker-group">
                                    <input type="color" id="square-color" name="square_color" value="{{ old('square_color', $qrCode->square_color ?? '#000000') }}">
                                    <input type="text" id="square-color-hex" value="{{ old('square_color', $qrCode->square_color ?? '#000000') }}">
                                </div>
                            </div>
                            <div class="color-group">
                                <label>Pixels:</label>
                                <div class="color-picker-group">
                                    <input type="color" id="pixel-color" name="pixel_color" value="{{ old('pixel_color', $qrCode->pixel_color ?? '#000000') }}">
                                    <input type="text" id="pixel-color-hex" value="{{ old('pixel_color', $qrCode->pixel_color ?? '#000000') }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="logo-options">
                            ...
                            @if($qrCode->logo_path)
                                <div class="logo-preview" id="logo-preview">
                                    <img id="logo-image" src="{{ asset('storage/' . $qrCode->logo_path) }}" alt="Logo Preview">
                            ...
                            <div class="logo-size">
                                ...
                                <input type="range" id="logo-size" name="logo_size" min="10" max="100" value="{{ old('logo_size', $qrCode->logo_size ?? 30) }}">
                                <span id="logo-size-value">{{ old('logo_size', $qrCode->logo_size ?? 30) }}%</span>
                            </div>
                            <div class="logo-margin">
                                <label>Logo Margin:</label>
                                <input type="range" id="logo-margin" name="logo_margin" min="0" max="30" value="{{ old('logo_margin', $qrCode->logo_margin ?? 4) }}">
                                <span id="logo-margin-value">{{ old('logo_margin', $qrCode->logo_margin ?? 4) }}px</span>
                            </div>
                        </div>
                        ...
                        <div class="pattern-options">
                            ...
                            <div class="pattern-grid">
                                @php $currentPattern = old('pattern_style', $qrCode->pattern_style ?? 'classic'); @endphp
                                <button type="button" class="pattern-btn {{ $currentPattern == 'classic' ? 'active' : '' }}" data-pattern="classic">
                                    <div class="pattern-preview classic"></div>
                                    <span>Classic</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'rounded' ? 'active' : '' }}" data-pattern="rounded">
                                    <div class="pattern-preview rounded"></div>
                                    <span>Rounded</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'dots' ? 'active' : '' }}" data-pattern="dots">
                                    <div class="pattern-preview dots"></div>
                                    <span>Dots</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'smooth' ? 'active' : '' }}" data-pattern="smooth">
                                    <div class="pattern-preview smooth"></div>
                                    <span>Smooth</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'diamond' ? 'active' : '' }}" data-pattern="diamond">
                                    <div class="pattern-preview diamond"></div>
                                    <span>Diamond</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'star' ? 'active' : '' }}" data-pattern="star">
                                    <div class="pattern-preview star"></div>
                                    <span>Star</span>
                                </button>
                                <button type="button" class="pattern-btn {{ $currentPattern == 'cross' ? 'active' : '' }}" data-pattern="cross">
                                    <div class="pattern-preview cross"></div>
                                    <span>Cross</span>
                                </button>
                            </div>
                            <input type="hidden" id="pattern-style" name="pattern_style" value="{{ $currentPattern }}">
                        </div>
                    </div>
                    <div class="design-section">
                ...
                <div class="qr-creator-panel preview-panel">
                    ...
                    <div class="qr-preview-container">
                        <div class="qr-preview" id="qr-preview">
                            <img src="{{ asset($qrCode->qrcode_image) }}" alt="Current QR Code">
                        </div>
                    </div>
